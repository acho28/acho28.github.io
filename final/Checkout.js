...
function loginhelp() {
	alert("Send an email to ***********@Gmail.com with your username and password and access will be restored shortly.");
}

function paynow() {
	if (confirm("Send payment directly to this address ***.***.*.* and your order will be processed shortly!")) {
		txt = "You pressed OK!";
